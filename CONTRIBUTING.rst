...
Report bugs at https://github.com/vahedashyan/django-tbot/issues.
...
The best way to send feedback is to file an issue at https://github.com/vahedashyan/django-tbot/issues.
...
Ready to contribute? Here's how to set up `django-tbot` for local development.

1. Fork the `django-tbot` repo on GitHub.
